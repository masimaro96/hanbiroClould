    ...
    <Box>
      <div style={StySpecification.StylesAll}>
        <div style={StySpecification.StylesContainer}>
          <div >
            <div >
              <h2 style={StySpecification.Title}>{title} 데이터베이스 요금안내</h2>
              <p style={StySpecification.Text}>
                <text>오토스케일링 및 Failover 지원, 고가용성 클라우드 {content} 데이터베이스
                </text>
              </p>
            </div>
          </div>
          ...
          <div style={StySpecification.BoxCenter}>
            <text style={StySpecification.TextCenter}>가상서버(인스턴스) 기반 단독 {content1} DATABASE</text>
          </div>
          <div style={StySpecification.ListProduct}>
