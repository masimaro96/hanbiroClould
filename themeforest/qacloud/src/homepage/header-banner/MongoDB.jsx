    ...
    <Box>
      <div style={StySpecification.StylesAll}>
        <div style={StySpecification.StylesContainer}>
          <div >
            <div >
              <h2 style={StySpecification.Title}> Kubernetes for MongDB 요금안내</h2>
              <p style={StySpecification.Text}>
                <text>리플리카구성, Node 및 Shard 분산처리, 대용량 고가용성 분산 클라우드 NoSQL MongoDB</text>
              </p>
            </div>
          </div>
          ...
          <div style={StySpecification.BoxCenter}>
            <text style={StySpecification.TextCenter}>가상서버(인스턴스) 기반 단독 MongoDB 데이터베이스 (최소 가상서버 2대로 구성)</text>
          </div>
          <div style={StySpecification.ListProduct}>
