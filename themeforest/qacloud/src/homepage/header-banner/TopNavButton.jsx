                    ...
                    <Row>
                        ...
                        <Col md={7}>
                            <div className="top-nav-right">
                                <div className="item-nav"><TopLink href="/qacloud"> 원격 지원 </TopLink></div>
                                <div className="item-nav"><TopLink href="https://member.hanbiro.com"> 서버호스팅 고객</TopLink></div>
                                <div className="item-nav"><TopLink href="https://mypage.hanbiro.com"> 웹호스팅 고객</TopLink></div>
                                <div className="item-nav"><TopLink href="http://comodossl.co.kr"> Sectigo(COMODO) SSL</TopLink></div>
                                <div className="item-nav"><TopLink href="http://blog.naver.com/hanbiro1999"> 한비로 블로그</TopLink></div>
                        ...
                        <Col md={3} sm={12}>
                            <div className="list-logo">
                                <div className="bar-logo ">
                                    <TopLink href="/qacloud"><img src={"https://www.hanbiro.com/cloud/images/logo.png"} style={{ width: 200, height: 50 }}></img></TopLink>
                                </div>
                            </div>
                        </Col>
                        <Col md={9} sm={12} >
                            <div className="bar-menu">
                                ...
                                <div className="bar-item btn-home">
                                    <TopLink href="/qacloud">{titleMenu("HOME", "Welcome")}</TopLink>
                                </div>
                                <div className="bar-item top-link">
                                    <Link to="/compute-vps" style={NavLink}>{titleMenu("클라우드", "Cloud")}</Link>
                                </div>
                                <div className="bar-item top-link"
                                >
                                    <Link to="/msa1" style={NavLink}>{titleMenu("마이크로서비스 개발", "Microservice")}</Link>
                                </div>
                        ...
                        <Col md={10} sm={12}>
                            <div className="btn-moble-list">
                                <div className="menu-mobile">
                                    ...
                                    <div className="bar-logo ">
                                        <TopLink href="/qacloud"><img src={"https://www.hanbiro.com/cloud/images/logo.png"} style={{ width: 150, height: 50 }}></img></TopLink>
                                    </div>
