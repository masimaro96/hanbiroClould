...
function BoxCard($title1,$description1,$title2,$description2,$title3,$description3,$title4,$description4) {
        ...
        <Container className="introduce-content">
            ...
            <Row className="introduce-content-row">
                <Col sm={12} md={6} className="Box1">
                    <GridCard>
                        <GridCardBody className='introduce-content-card'>
                            <TypographyCard className="intro-title">{$title3}</TypographyCard>
                            <TypographyCard className="intro-description">{$description3}</TypographyCard>
                        </GridCardBody>
                    </GridCard>
                </Col>
                <Col sm={12} md={6} className="Box1">
                    <GridCard>
                        <GridCardBody className='introduce-content-card'>
                            <TypographyCard className="intro-title">{$title4}</TypographyCard>
                            <TypographyCard className="intro-description">{$description4}</TypographyCard>
                        </GridCardBody>
                    </GridCard>
                </Col>
            </Row>
