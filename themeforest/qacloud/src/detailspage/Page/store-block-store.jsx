            ...
            <Container>
                <Row>
                    ...
                    <Col md={12} lg={9}>
                        ...
                        {Contentcloudcompute("한비로 Cloud 서버의  저장용량을 실시간확장", "","스냅샷기능을 제공하며, 3 Replica 블록 Storage 운영","","데이터를 일정한 크기의 블록으로 나누어 저장 하는","방식이며, 한비로 Cloud 관리자콘솔에서 생성후","수분내에 볼륨을 사용할 수 있습니다. 한비로 Cloud 의","블록 Storage 에서 생성된 볼륨은 운영체제의","제한사항이 없습니다.","스냅샷 기능을 제공하며, 볼륨의 백업및 복제와","복원시에 사용됩니다. 블록 Storage 의 볼륨을 3","replica SET 으로 운영합니다.","","")}
